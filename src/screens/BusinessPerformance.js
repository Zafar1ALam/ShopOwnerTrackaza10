        ...
        <ScrollView>
            <View style={STYLES.withoutpaddingcontainer}>
                ...
                <View style={[{
                    ...
                    <DoubleTextSvgHeader xml={Svgs.goBack} xml1={Svgs.business}
                        text="Business Performance" text1="Shop Name Here"
                ...
                <View style={{
                    ...
                    <DataTable style={{
                        ...
                        <DataTable.Header style={{           //
                            ...
                            <DataTable.Title style={{ justifyContent: 'center' }} >
                                <Text style={STYLES.fontSize18_074B08_Arial_Bold}>Sales</Text>
                            </DataTable.Title>
                                    ...
                                    <View key={records.id}>
                                        <DataTable.Row
                                            ...
                                            <DataTable.Cell style={{ justifyContent: 'center' }}>
                                                <Text style={STYLES.fontSize18_black161923_Arial_400}>{records.productName}</Text></DataTable.Cell>
                                            <DataTable.Cell style={{ justifyContent: 'center' }} >
                                                <Text style={STYLES.fontSize18_black161923_Arial_400}>{records.price}</Text></DataTable.Cell>
                                            ...
                                            <DataTable.Cell style={{
                                                ...
                                                <Text style={STYLES.fontSize18_black161923_Arial_400}>{records.sales}</Text>
