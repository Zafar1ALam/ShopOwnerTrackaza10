...
const AddManager = ({ route, navigation }) => {
    ...
    const [stateImageBase64, setStateImageBase64] = useState();
    ...
    const addManager = () => {
        ...
        if (stateData.email != '' && stateData.password != ''
            ...
            console.log(`https://trackaza-app.herokuapp.com/api/manager/signup email : ${stateData.email}
             username : ${stateData.email} password : ${stateData.password}`)
            fetch('https://trackaza-app.herokuapp.com/api/manager/signup', {
                method: 'POST',
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    username: stateData.managerName,
                ...
                .then((json) => {
                    ...
                    console.log('https://trackaza-app.herokuapp.com/api/manager/updateManagerProfilePic/' +
                        json.ManagerId + ' profilePic:' + stateImage)
                    if (json.succes) {

                        RNFetchBlob.fetch('PUT',
                            'https://trackaza-app.herokuapp.com/api/manager/updateManagerProfilePic/' +
                            json.ManagerId,
                            {
                            ...
                            if (obj.succes) {
                                SweetAlert.showAlertWithOptions({
                                    title: 'Manager Successfully Add',
                                    //  subTitle: '',
                    ...
                    {stateImage === null ?
                        ...
                        <TouchableRipple onPress={() => refRBSheetCamera.current.open()}
                            ...
                            <>
                                ...
                                <Text style={[STYLES.fontSize11_green074B08_Arial_Bold,
                                { marginTop: '3%' }]}>Update Manager Image</Text>
                            </>
                        </TouchableRipple>
                    }
